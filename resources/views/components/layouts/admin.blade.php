...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-primary-50">
    ...
    <div x-data="{ mobileMenuOpen: false }">
        ...
        <div class="relative z-50 lg:hidden" x-show="mobileMenuOpen" role="dialog" aria-modal="true">
            ...
            <div class="fixed inset-0 flex">
                ...
                >
                    ...
                    <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-primary-900 px-6 pb-2">
                        <div class="flex h-16 shrink-0 items-center">
                            <x-logo class="block h-8 text-primary-800" />
                        </div>
                        <nav class="flex flex-1 flex-col">
                            <ul role="list" class="flex flex-1 flex-col gap-y-7">
                                <li>
                                    <ul role="list" class="-mx-2 space-y-1">
                                        <x-menu-item title="Dashboard" route="dashboard" icon="fa">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                                        </x-menu-item>
                                        <x-menu-item title="Features" route="dashboard.features">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25ZM6.75 12h.008v.008H6.75V12Zm0 3h.008v.008H6.75V15Zm0 3h.008v.008H6.75V18Z" />
                                        </x-menu-item>
                                        <x-menu-item title="Clients" route="dashboard.clients">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21" />
                                        </x-menu-item>

                                        <x-menu-item title="Proposal" route="dashboard.proposals">
                                ...
                                <li>
                                    ...
                                    <ul role="list" class="-mx-2 mt-2 space-y-1">
                                        <x-menu-item title="Users" route="dashboard.users">
        ...
        <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
            <!-- Sidebar component, swap this element with another sidebar if you like -->
            <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-primary-900 px-6">
                <div class="flex h-16 shrink-0 items-center">
                    <x-logo class="block h-8 text-primary-100" />
                </div>
                <nav class="flex flex-1 flex-col">
                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                        <li>
