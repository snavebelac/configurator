...
<form wire:submit.prevent="save">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                ...
                <div class="sm:col-span-6">
                    <label for="active" class="flex items-center gap-2 text-sm/6 font-medium text-gray-900">
                        <input type="checkbox" name="active" id="active"  wire:model="active" class="bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                        Active
                    </label>
    ...
    <div class="mt-6 flex items-center justify-end gap-x-6">
        ...
        <button type="submit" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{{ $user ? 'Update' : 'Create' }}</button>
    </div>
</form>
</x-modal>
