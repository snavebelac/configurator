<x-modal
    ...
    subtitle="Its features will be added to your selection, with any package overrides applied at create time.">
        ...
        @empty
            <div class="px-5 py-10 text-center text-sm text-slate">
                ...
                @else
                    ...
                    <p class="mt-1.5">Create a package from the Packages page first.</p>
                @endif
            </div>
        @endforelse
    </div>
